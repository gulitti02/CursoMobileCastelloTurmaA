...
class _MyAppState extends State<MyApp> {
  ...
  _nomeController; // vai controlar a inserção de texto dentro do TextFormField
  ...
  void _salvarPreferencias() async {
    ...
    Map<String, dynamic> config = {
      ...
      "nome": _nomeController.text.trim(), //remove espaços em branco
    };
